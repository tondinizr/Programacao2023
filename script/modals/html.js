...
<div class="content">
    ...
    <p class="text"><strong class="text">Linha 1:</strong> a instrução DOCTYPE deve ser sempre a primeira a aparecer em uma página HTML para indicar ao browser qual versão da linguagem usada. Nesse caso, estamos trabalhando com a HTML5, versão na qual a declaração do DOCTYPE é bastante simples, como podemos ver na listagem;</p>
    <br>
    <p class="text"><strong class="text">Linhas 2 e 10:</strong> abertura e fechamento da tag html, que delimita o documento. Sendo assim, todas as demais tags da página devem estar nesse espaço; </p>
    <br>
    ...
    <br>
    <p class="text"><strong class="text">Linha 4:</strong> a tag meta, nesse caso, especifica qual conjunto de caracteres (character set ou charset) será usado para renderizar o texto da página. O UTF-8 contém todos os caracteres dos padrões Unicode e ASCII, sendo, portanto, o mais utilizado em páginas web. A mesma tag meta, porém com outros atributos, pode ser utilizada para outros fins, como na SEO (Search Engine Optimization); </p>
    <br>
    <p class="text"><strong class="text">Linha 5:</strong> a tag title define o título da página, aquele que aparece na janela/aba do navegador; </p>
    <br>
    <p class="text"><strong class="text">Linhas 7 e 9:</strong> abertura e fechamento da tag body, marcando o espaço no qual deve estar contido o conteúdo visual da página. As demais tags que representam texto, botões etc. devem ser adicionadas nesse intervalo; </p>
    <br>
