...
<div class="content">
    ...
    <a class="text" target="_blank" href="https://www.w3schools.com/css/">
        🧑‍💻 W3Schools
    </a>
    <a class="text" target="_blank" href="https://web.dev/learn/css/box-model/">
        📖 web.dev
    </a>
    <a class="text" target="_blank" href="https://css-tricks.com/">
        🎆 Css-Tricks
    </a>
    <pre class="code">
        <code class="text"> <span class="brilliantRose">body</span><span class="arylideYellow">{</span></code>
        <code class="text">     <span class="purpleNavy">padding</span><span class="brilliantRose">:</span><span class="blizzardBlue">0</span><span class="gainsboro">;</span></code>
        <code class="text"> <span class="arylideYellow">}</span></code>
        <code class="text"></code>
        <code class="text"> <span class="pastelGreen">.classe</span><span class="arylideYellow">{</span></code>
        <code class="text">     <span class="purpleNavy">height</span><span class="brilliantRose">:</span><span class="blizzardBlue">10</span><span class="brilliantRose">px</span><span class="gainsboro">;</span></code>
        <code class="text"> <span class="arylideYellow">}</span></code>
        <code class="text"></code>
        <code class="text"> <span class="pastelGreen">#id</span><span class="arylideYellow">{</span></code>
